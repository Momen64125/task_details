...
extension WidgetPaddingX on Widget {
  ...
  Widget get horizontalScreenPadding => Padding(
        child: this,
        padding: EdgeInsets.symmetric(horizontal: Sizes.size16.w),
      );

  Widget get defaultHorizontalScreenPadding => Padding(
        child: this,
        padding: EdgeInsets.symmetric(horizontal: Sizes.size10.w),
      );

  Widget get verticalScreenPadding => Padding(
        child: this,
        padding: EdgeInsets.symmetric(vertical: Sizes.size10.h),
      );
